$(document).ready(function() {
	...
	if (lang=="en") {
		var arrCities = ['Sandwich" Caprese "',
"Sandwich with ham and cheese", "Sandwich with chicken, bacon and avocado",
"Egg and Spinach Sandwich", "Mexican Burger",
"Club Sandwich", "Quick Chicken Pie",
"Cheese and smoked salmon sandwich"]; // Change number of slides in CSS also
	}
	else if (lang=="ua") {
		var arrCities = ['Сендвіч "Капрезе"',
"Сендвіч з шинкою і сиром", "Сендвіч з куркою, беконом і авокадо",
"Сендвіч з яйцем і шпинатом", "Бургер по-мексиканськи",
"Клубний сендвіч", "Швидкий курячий пиріг",
"Бутерброд з сиром і копченим лососем"]; // Change number of slides in CSS also
	}
	else {
		var arrCities = ['Сэндвич "Капрезе"',
